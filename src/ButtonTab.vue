...
<template>
  <div
    class="admin-tab-button-tab"
    :class="{ 'admin-tab-button-tab-unclosable': !closable }"
    :style="buttonStyle"
    @mouseenter="setTrue"
    @mouseleave="setFalse"
  >
    <span class="admin-tab-button-tab-prefix">
      <slot />
    </span>
    <div v-if="closable" class="admin-tab-button-tab-icon">
